...
{
    public class InventarioDetalleRepositorio : Repositorio<InventarioDetalle>, IInventarioDetalleRepositorio // este va heredar del repositorio de bodega  y Ibodega , nos va generar
                                                                                                             ...
                                                                                                             //el repositorio al  padre 
    {
        ...
        public void Actualizar(InventarioDetalle inventarioDetalle)
        {
            ...
            var inventarioDetalleBD = _db.InventarioDetalles.FirstOrDefault(b => b.Id == inventarioDetalle.Id);  // aqui estamos capturando el registro antes de actulaizarlo ahora vamos a validar si este es un valor a diferente anulo 
