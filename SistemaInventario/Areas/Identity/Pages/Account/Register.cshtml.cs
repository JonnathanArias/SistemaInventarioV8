    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //vamos autilizar el modelo aplicacion UsuarioAplicacion, para que se carguen automaticamente
                ...
                if (result.Succeeded)
                {
                    ...
                    // este es para que realzie una validacion y e valide si existe los roles y si no que los cree
                    ...
                    //condicion lo que se recibe del page, siempre lo recibe del page
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmacion de tu Email",
                       $"Confirma tu cuenta, Gracias! <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Haz Click en el enlace. gracias!</a>.");
                    ...
                    else
                    {
                        ...
                        {
                            //administrador esta registrando un nuevo usuario y quiere conservar su mismo usuairo logueado 
